...
add_action( 'enqueue_block_editor_assets', '_twp_enqueue_block_editor_script' );

/**
 * Enqueue the script necessary to support Tailwind Typography in the block
 * editor, using an inline script to create a JavaScript array containing the
 * Tailwind Typography classes from _TWP_TYPOGRAPHY_CLASSES.
 */
function _twp_enqueue_typography_script() {
	if ( is_admin() ) {
		wp_enqueue_script(
			'_twp-typography',
		...
		wp_add_inline_script( '_twp-typography', "tailwindTypographyClasses = '" . esc_attr( _TWP_TYPOGRAPHY_CLASSES ) . "'.split(' ');", 'before' );
	}
}
add_action( 'enqueue_block_assets', '_twp_enqueue_typography_script' );
